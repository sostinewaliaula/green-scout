...
export function ScoutSectionCms() {
  ...
  if (loading) {
    return (
      <section id="scouts" className="py-20 px-4 md:px-8 bg-white dark:bg-gray-900">
  ...
  return (
    <section id="scouts" className="py-20 px-4 md:px-8 bg-white dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-green-100 to-purple-100 dark:from-green-900/30 dark:to-purple-900/30 rounded-xl shadow-lg dark:shadow-gray-900/50 overflow-hidden hover:shadow-xl dark:hover:shadow-gray-900 transition-shadow">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-2/5 overflow-hidden">
              {scoutBlock.image?.asset?.url ? (
                ...
                <div className="w-full h-full bg-gradient-to-br from-green-200 to-purple-200 dark:from-green-900/40 dark:to-purple-900/40 flex items-center justify-center">
            ...
            <div className="md:w-3/5 p-6 md:p-8 flex flex-col justify-center">
              {scoutBlock.month && (
                <div className="inline-block px-4 py-1 rounded-full bg-purple-200 dark:bg-purple-900/40 text-purple-800 dark:text-purple-400 font-medium text-sm mb-4 self-start">
                  {scoutBlock.month}
                </div>
              )}
              ...
              {scoutBlock.school && (
                <p className="text-lg text-green-800 dark:text-green-400 font-medium mb-4">
                  {scoutBlock.school}
                </p>
              )}
              {scoutBlock.description && (
                <p className="text-gray-700 dark:text-gray-300 mb-6">{scoutBlock.description}</p>
              )}
              ...
              {scoutBlock.quote && (
                <blockquote className="mt-6 italic text-gray-600 dark:text-gray-400 border-l-4 border-purple-500 dark:border-purple-400 pl-4">
                  "{scoutBlock.quote}"
                </blockquote>
              )}
            </div>
