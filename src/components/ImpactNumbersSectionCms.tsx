...
export function ImpactNumbersSectionCms() {
  ...
  if (loading) {
    return (
      <section className="py-16 px-4 md:px-8 bg-gradient-to-r from-green-50 to-purple-50 dark:from-gray-900 dark:to-gray-800">
        <div className="max-w-5xl mx-auto text-center text-gray-600 dark:text-gray-400">Loading impact numbers...</div>
      </section>
    );
  }
  ...
  return (
    <section className="py-16 px-4 md:px-8 bg-gradient-to-r from-green-50 to-purple-50 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-5xl mx-auto">
        {numbersBlock.title && (
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-10 text-green-700 dark:text-green-400">
            {numbersBlock.title}
          </h2>
        )}
