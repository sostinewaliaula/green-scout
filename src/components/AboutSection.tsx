...
export function AboutSection() {
  ...
  return (
    <section id="about" className="py-20 px-4 md:px-8 bg-green-100 dark:bg-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col">
            <div className="space-y-4">
              {introText ? (
                introText.split('\n\n').map((p, i) => (
                  <p key={i} className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">{p}</p>
                ))
              ) : (
                <>
